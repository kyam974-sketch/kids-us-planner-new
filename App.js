...
function LessonView(props) {
  ...
  var startH = Number(startParts[0]);
  var startM = Number(startParts[1]);
  var startMs = (startH * 60 + startM) * 60000;
  var nowMs = (now.getHours() * 60 + now.getMinutes()) * 60000 + now.getSeconds() * 1000;
  var elapsedMinutes = (nowMs - startMs) / 60000;
  var markerTop = 150 + (elapsedMinutes * 15);
    ...
    React.createElement("div", {
      ...
      React.createElement("div", { style:{ maxWidth:900, margin:"0 auto", padding: isLive ? 20 : 30 } },
        React.createElement("div", { style:{ background: isLive ? "#000" : "#fff", padding: isLive ? 20 : 45, borderRadius: isLive ? 0 : 35, position:"relative" } },
          isLive && React.createElement("div", { style:{ position:"absolute", left:0, right:0, top:markerTop, borderTop:"3px solid #FF7675", zIndex:50 } }),
