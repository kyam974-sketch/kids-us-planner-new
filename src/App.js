...
```
  ...
  {syncing && <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.4)", display:"flex", alignItems:"center", justifyContent:"center", zIndex: 20000 }}><div style={{background:"#fff", padding:30, borderRadius:20, fontWeight:900, fontSize:18}}>⏳ Syncing...</div></div>}
</div>
```
